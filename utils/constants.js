...
export const RESTAURANT_API ="https://www.swiggy.com/dapi/restaurants/list/v5?lat=26.9059311&lng=75.78443829999999&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
...
export const PROXY_RES_API = `/api/proxy?url=${encodeURIComponent(RESTAURANT_API)}`;